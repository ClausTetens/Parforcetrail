<div class="wrap">
	...
	<h2 class="one-logo"> 
		<div class="textleft">
			...
			<span>
				<?php _e( 'Presenting some of the best WordPress plugins, curated for quality.', 'onecom-wp' ); ?>
			</span>
		</div>
		<div class="textright">
	...
	<div class="wrap_inner inner one_wrap">
		<div class="nav-tab-wrapper">
			<a href="<?php echo ( is_multisite() ) ? network_admin_url( 'admin.php?page=onecom-wp-plugins' ) : admin_url( 'admin.php?page=onecom-wp-plugins' ); ?>" class="nav-tab nav-tab-active"><?php _e( 'One.com plugins', 'onecom-wp' ); ?></a>
		    <a href="<?php echo ( is_multisite() ) ? network_admin_url( 'admin.php?page=onecom-wp-recommended-plugins' ) : admin_url( 'admin.php?page=onecom-wp-recommended-plugins' ); ?>" class="nav-tab"><?php _e( 'Recommended plugins', 'onecom-wp' ); ?></a>
									...
									<ul class="plugin-action-buttons">
										<li>
											...
											<?php elseif ( $plugin_installed && ( ! $plugin_activated ) ) : ?>
												...
												<?php endif; ?>
											<?php else : ?>
												<a class="install-now button" href="javascript:void(0)" data-slug="<?php echo $plugin->slug; ?>" data-name="<?php echo $plugin->name ?>" aria-label="Install <?php echo $plugin->name ?> now" data-action="onecom_install_plugin" data-redirect="<?php echo $plugin->redirect; ?>"><?php _e( 'Install now', 'onecom-wp' ); ?></a>
											<?php endif; ?>
										</li>
										<!-- <li>
											<?php
