<div class="wrap">
	...
	<div class="wrap_inner inner one_wrap">
		<div class="nav-tab-wrapper">
			<a href="<?php echo ( is_multisite() ) ? network_admin_url( 'admin.php?page=onecom-wp-plugins' ) : admin_url( 'admin.php?page=onecom-wp-plugins' ); ?>" class="nav-tab"><?php _e( 'One.com plugins', 'onecom-wp' ); ?></a>
		    <a href="<?php echo ( is_multisite() ) ? network_admin_url( 'admin.php?page=onecom-wp-recommended-plugins' ) : admin_url( 'admin.php?page=onecom-wp-recommended-plugins' ); ?>" class="nav-tab nav-tab-active"><?php _e( 'Recommended plugins', 'onecom-wp' ); ?></a>
